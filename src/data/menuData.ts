...
export const menuData: MenuData = {
    burgers: [
        ...
        {id: 3, name: "Signature burger", nameKey: "signature_burger", ingredients: 'ingredients_signature_burger', price: '4.50€', img: signatureBurger, badge: {include: false}, type:'burger'},
        {id: 4, name: "Fish burger", nameKey: "fish_burger", ingredients: 'ingredients_fish_burger', price: '5.90€', img: fishBurger, badge: {include: false}, type:'burger'},
        {id: 5, name: "Truffle burger", nameKey:"truffle_burger", ingredients: 'ingredients_truffle_burger', price: '6.90€', img: truffleBurger, badge: {include: false}, type:'burger'},
        {id: 6, name: "Chicken burger", ingredients: 'ingredients_chicken_burger', price: '5.50€', img: chickenBurger, badge: {include: false}, type:'burger'},
        {id: 7, name: "Swiss burger", nameKey:'swiss_burger', ingredients: 'ingredients_swiss_burger', price: '5.90€', img: swissBurger, badge: {include: false}, type:'burger'},
        {id: 8, name: "Teriyaki burger", ingredients: 'ingredients_teriyaki_burger', price: '5.50€', img: teriyakiBurger, badge: {include: false}, type:'burger'}
    ],
    ...
    beverages: [
        ...
        {id: 20, name: "Hot chocolate", nameKey:'hot_chocolate', ingredients: 'ingredients_hot_chocolate', price: '3.00€', img: hotChocolate, badge: {include: false}, type:'hot-drink'},
        {id: 21, name: "Blond beer", nameKey:'blond_beer', ingredients: 'ingredients_blond_beer', price: '3.50€', img: blondBeer, badge: {include: false}},
        {id: 22, name: "Lager beer", nameKey:'lager_beer', ingredients: 'ingredients_lager_beer', price: '3.00€', img: lagerBeer, badge: {include: false}},
    ...
    desserts: [
        ...
        {id: 27, name: "Churros", ingredients: 'ingredients_churros', price: '3.00€', img: churros, badge: {include: false}},
        {id: 28, name: "Waffles", nameKey: 'waffles', ingredients: 'ingredients_waffles', price: '4.50€', img: waffles, badge: {include: false}},
        {id: 29, name: "Matcha ice cream", nameKey:'matcha_ice_cream', ingredients: 'ingredients_matcha_ice_cream', price: '4.50€', img: matchaIceCream, badge: {include: false}, type:'ice-cream'}
    ]
